...
# CMD ["sh", "-c", "php artisan config:clear && php artisan key:generate && php artisan session:table && php artisan migrate --force && php artisan serve --host=0.0.0.0 --port=10000"]
...
# Step 8: Run Laravel setup and server
